...
# NOTE! Any lines in the Prolog file which are not facts or rules (including comments) are assumed "corrupted"
# and won`t be parsed.
...
# Consulting Prolog code and parsing it into lists of facts and rules respectively
while True:
